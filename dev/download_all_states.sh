...
# Script para download sequencial de todos os estados
# Utiliza os timeouts específicos definidos em .config.env
...
# Função principal
main() {
    log "Iniciando download sequencial de todos os estados..."
    log "Total de estados: ${#STATES[@]}"
